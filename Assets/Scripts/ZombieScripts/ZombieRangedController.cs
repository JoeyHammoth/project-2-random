...
public class ZombieRangedController : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource throwingAxeSound;
    ...
    private void SpawnProjectile()
    {
        ...
        Instantiate(projectilePrefab, spawnPosition, zombie.transform.rotation);
    }
